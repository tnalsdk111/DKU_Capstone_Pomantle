...
export const InitHolistic = (onResultsCallback) => { // 이걸 통해서 Holistic을 초기화 해 반환
    // setUpHolistic
...
export const drawHolisticResults = (results, canvasRef, videoElement) => {
    ...
    if(results.poseLandmarks){
        drawConnectors(canvasCtx, results.poseLandmarks, poseConnections, {color: '#00FF00', lineWidth: lineWidth}); // 팔꿈치 까지만 연결
